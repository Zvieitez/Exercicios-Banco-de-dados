...
select *
from public.db_endereco

select *
from public.db_contato

select * from db_cliente cl
inner join db_contato co on cl.id = co.cliente_id 
inner join db_endereco en on cl.id  = en.cliente_id 
where cl.id = 5; /*consultar algo específico*/
